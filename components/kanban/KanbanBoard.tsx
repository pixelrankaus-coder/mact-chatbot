...
const initialTasks: Task[] = [
  {
    ...
    assignees: [
      { name: "Emily J", initials: "EJ" },
      { name: "David S", initials: "DS" },
    ],
    progress: 0,
    priority: "medium",
    attachments: 1,
  ...
  },
  {
    ...
    description: "Compile competitor landing page designs for inspiration. G...",
    assignees: [
      { name: "Ryan B", initials: "RB" },
      { name: "Kate S", initials: "KS" },
    ],
    progress: 55,
    priority: "medium",
    attachments: 3,
  ...
  },
  {
    ...
    description: "Compile competitor landing page designs for inspiration. G...",
    assignees: [
      { name: "Nick T", initials: "NT" },
      { name: "Eve L", initials: "EL" },
    ],
    progress: 35,
    priority: "low",
    attachments: 1,
  ...
  },
  {
    ...
    description: "Compile competitor landing page designs for inspiration. G...",
    assignees: [
      { name: "Eric C", initials: "EC" },
      { name: "Grace R", initials: "GR" },
    ],
    progress: 100,
    priority: "high",
    attachments: 2,
  ...
  },
  {
    ...
    description: "Compile competitor landing page designs for inspiration. G...",
    assignees: [
      { name: "Henry L", initials: "HL" },
      { name: "Beth M", initials: "BM" },
    ],
    progress: 100,
    priority: "medium",
    attachments: 1,
